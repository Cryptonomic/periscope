    ...
    return (
        <div>
            <Holder>
                ...
                <List className="head">
                    <ListItem>
                        <NavLink exact activeClassName="selected" className="main-style" to="/">
                            <svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M15.1579 0.95C13.5909 0.95 12.3158 2.2287 12.3158 3.8C12.3158 4.2769 12.4446 4.7196 12.6512 5.11575L11.5939 6.35265C10.9685 5.92666 10.2297 5.69925 9.47368 5.7C8.77358 5.7 8.12368 5.9052 7.56 6.2377L6.22042 4.8944C6.48653 4.41411 6.62791 3.87443 6.63158 3.325C6.63158 1.4915 5.14421 0 3.31579 0C1.48737 0 0 1.4915 0 3.325C0 5.1585 1.48737 6.65 3.31579 6.65C3.88516 6.65 4.41284 6.4923 4.88084 6.2377L6.22042 7.581C5.87342 8.16092 5.68822 8.82371 5.68421 9.5C5.68421 10.4472 6.04421 11.304 6.61737 11.971L5.01442 13.5783L5.03811 13.6021C4.65078 13.4059 4.22338 13.3025 3.78947 13.3C2.22253 13.3 0.947368 14.5787 0.947368 16.15C0.947368 17.7213 2.22253 19 3.78947 19C5.35642 19 6.63158 17.7213 6.63158 16.15C6.63158 15.6978 6.51695 15.2769 6.33032 14.8979L6.354 14.9217L8.20516 13.0654C8.604 13.2079 9.02653 13.3 9.47368 13.3C11.5636 13.3 13.2632 11.5957 13.2632 9.5C13.2591 8.90986 13.1166 8.32896 12.8473 7.80425L14.0343 6.41535C14.3792 6.56545 14.7581 6.65 15.1579 6.65C16.7248 6.65 18 5.3713 18 3.8C18 2.2287 16.7248 0.95 15.1579 0.95ZM3.78947 17.1C3.53822 17.1 3.29725 16.9999 3.11958 16.8218C2.94192 16.6436 2.84211 16.402 2.84211 16.15C2.84211 15.898 2.94192 15.6564 3.11958 15.4782C3.29725 15.3001 3.53822 15.2 3.78947 15.2C4.04073 15.2 4.2817 15.3001 4.45936 15.4782C4.63703 15.6564 4.73684 15.898 4.73684 16.15C4.73684 16.402 4.63703 16.6436 4.45936 16.8218C4.2817 16.9999 4.04073 17.1 3.78947 17.1ZM1.89474 3.325C1.89474 2.53935 2.53232 1.9 3.31579 1.9C4.09926 1.9 4.73684 2.53935 4.73684 3.325C4.73684 4.11065 4.09926 4.75 3.31579 4.75C2.53232 4.75 1.89474 4.11065 1.89474 3.325ZM9.47368 11.4C8.42874 11.4 7.57895 10.5478 7.57895 9.5C7.57895 8.45215 8.42874 7.6 9.47368 7.6C10.5186 7.6 11.3684 8.45215 11.3684 9.5C11.3684 10.5478 10.5186 11.4 9.47368 11.4ZM15.1579 4.75C14.9066 4.75 14.6657 4.64991 14.488 4.47175C14.3103 4.29359 14.2105 4.05196 14.2105 3.8C14.2105 3.54804 14.3103 3.30641 14.488 3.12825C14.6657 2.95009 14.9066 2.85 15.1579 2.85C15.4092 2.85 15.6501 2.95009 15.8278 3.12825C16.0055 3.30641 16.1053 3.54804 16.1053 3.8C16.1053 4.05196 16.0055 4.29359 15.8278 4.47175C15.6501 4.64991 15.4092 4.75 15.1579 4.75Z" fill="#8492A4"/>
                            </svg>
                            Tezos Network Overview
                        </NavLink>
                    </ListItem>
                </List>
                <List className="head">
                ...
                <List className="head">
                    <ListItem>
                        <NavLink activeClassName="selected" className="main-style" to="/bakers">
                ...
                <List className="head">
                    <ListItem>
                        <NavLink activeClassName="selected" className="main-style" to="/contracts">
                        <svg width="17" height="17" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M10.9248 3.25393V1.10889C10.9248 1.10889 11.0954 1.15726 11.192 1.24792C11.914 1.92568 12.9507 2.84855 13.0683 3.00666C13.22 3.21066 13.2332 3.25393 13.2332 3.25393H10.9248Z" stroke="white" strokeWidth="0.3"/>
                ...
                <List className="head">
                    <ListItem>
                    <NavLink activeClassName="selected" className="main-style" to="/blocks">
                ...
                <List className="head">
                    <ListItem>
                        <NavLink activeClassName="selected" className="main-style" to='/operations'>
